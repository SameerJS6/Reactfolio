   ...
   <>
     <header data-overlay={`${isOpen ? "true" : "false"}`} >
      ...
      <div className="hamburger p-1 | opacity" ref={ buttonRef }>
        <button className={`hamburger hamburger-spin ${isOpen ? "is-active" : ''}`} type="button" onClick={() => setIsOpen(!isOpen)}>
        ...
        <svg className="svg-logo | fade-in-fwd" width="138" height="20" xmlns="http://www.w3.org/2000/svg">
      ...
      <nav className={`${isOpen ? "open" : ""}`}>
        <ul className={`nav-list ${isOpen ? 'active' : ''}`}>
          <li className='tracking-in'><a href='#'>Collections</a></li>
          <li className='tracking-in'><a href="#">Men</a></li>
          <li className='tracking-in'><a href="#">Women</a></li>
          <li className='tracking-in'><a href="#">About</a></li>
          <li className='tracking-in'><a href='#'>Contact</a></li>
        </ul>
      </nav>

      <div className="buttons-wrapper">
        <div> 
          <div className='cart-wrapper | fade-in-fwd' data-after={`${cartIsOpen ? 'true' : 'false'}`} onClick={()=> setCartIsOpen(!cartIsOpen)}>

   ...
   <>
     <header data-overlay={`${isOpen ? "true" : "false"}`} >
      ...
      <button className="hamburger" onClick={() => setIsOpen(!isOpen)}>
        {!isOpen && <svg width="16" height="15" xmlns="http://www.w3.org/2000/svg">
          <path d="M16 12v3H0v-3h16Zm0-6v3H0V6h16Zm0-6v3H0V0h16Z" fill="#69707D" fillRule="evenodd"/>
        </svg>}

        {isOpen && <svg className="close-svg" width="16" height="15" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="svg-logo" width="138" height="20" xmlns="http://www.w3.org/2000/svg">

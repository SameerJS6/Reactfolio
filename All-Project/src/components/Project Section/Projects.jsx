...
export default function Projects({
  ...
  return (
    <article className="card-background | overflow-hidden rounded-[2.5rem] bg-primary bg-opacity-[0.05] text-onBackground transition-all duration-300 active:rounded-3xl sm:min-w-[321px] md:min-h-[350px]">
      <a

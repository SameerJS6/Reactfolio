...
export default function About() {
  return (
    <section className="mx-6 lg:mx-12" id="About">
      <div className="about-gradient my-4 mt-16 grid min-h-[300px] rounded-3xl px-4 py-2 sm:my-10 sm:mt-20 sm:rounded-[2.5rem] sm:py-2 md:my-[3.5rem] md:mt-20 md:rounded-[3rem] md:py-2 lg:my-20 lg:mt-28 lg:min-h-[450px] lg:py-4">

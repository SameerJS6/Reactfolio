export default function About() {
  return (
    <section
      className="mx-6 py-12 pb-4 text-onBackground lg:mx-12 lg:py-8 lg:pb-2 xl:py-20"
      id="About"
    >
      <div className="about-gradient my-4 mb-4 mt-8 grid min-h-[300px] rounded-3xl px-4 py-2 sm:my-10 sm:mt-20 sm:rounded-[2.5rem] sm:py-2 md:rounded-[3rem] lg:my-20 lg:mt-16 lg:min-h-[450px] lg:py-4">
        <div className="flex flex-col justify-center gap-2 px-2 py-12 text-left transition-colors duration-300 sm:gap-4 sm:px-8 lg:gap-6 xl:gap-4 xl:py-24">
          <h2

...
export default function Navbar() {
  ...
  return (
    <>
      <header
        className="absolute inset-auto w-full flex justify-between items-center py-3 px-4 lg:px-8 lg:py-4 max-w-[1440px] lg:mx-auto"
        data-overlay={`${isactive ? "true" : "false"}`}
      >
        <div className="nav-gsap">
        ...
        <nav
          className="navbar | shadow-xl rounded-xl lg:shadow-none font-barlow font-semibold text-[var(--neutral-gray)] transition-colors duration-300 "
          data-active={`${isactive ? "true" : "false"}`}
        >
          <ul className="flex flex-col lg:flex-row gap-2 lg:gap-4">
            <li className="nav-gsap">
              <Ripples>
                <a
        ...
        <div className="block lg:hidden rounded-full">
          <Ripples>
            <button
              className="nav-gsap block lg:hidden rounded-full p-3 aspect-square"

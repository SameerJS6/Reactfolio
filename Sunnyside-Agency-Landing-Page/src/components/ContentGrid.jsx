      ...
      <article className="flex flex-col md:grid md:grid-cols-2">
        <div className="main-content-grid | grid place-content-center gap-4">
          ...
          <div className="content | text-center py-20 px-8 md:p-8 lg:p-16 xl:p-20">
            <h2 className="font-fraunces leading-[3] md:leading-[2] lg:leading-[3] text-3xl md:text-4xl lg:text-5xl md:width-[15ch]  text-[var(--cyan)]">
              Graphic Design
            </h2>
        ...
        <div className="main-content-grid | grid place-content-center gap-4">
          ...
          <div className="content | text-center py-20 px-8 md:p-8 lg:p-16 xl:p-20">
            <h2 className="font-fraunces leading-[3] md:leading-[2] lg:leading-[3] text-3xl md:text-4xl lg:text-5xl md:width-[15ch] text-[var(--blue)]">
              Photography
            </h2>
